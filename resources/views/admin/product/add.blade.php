                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" name="time_create" class="form-control" value="{{old('time_create')}}" placeholder="Nhập tiêu đề...">
                                    @error('time_create')
                         ...
                         <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="link_ytb" class="form-control" value="{{old('link_ytb')}}" placeholder="Nhập Link.">
                                    @error('link_ytb')
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="link_ytb_topic" class="form-control" value="{{old('link_ytb_topic')}}" placeholder="Nhập Link.">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="link_zing" class="form-control" value="{{old('link_zing')}}" placeholder="Nhập Link.">
                                    @error('link_zing')
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="link_spotify" class="form-control" value="{{old('link_spotify')}}" placeholder="Nhập Link.">
                                    @error('link_spotify')
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="link_apple" class="form-control" value="{{old('link_apple')}}" placeholder="Nhập Link.">
                                    @error('link_apple')
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="link_NCT" class="form-control" value="{{old('link_NCT')}}" placeholder="Nhập Link.">
                                    @error('link_NCT')
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="link_tiktok" class="form-control" value="{{old('link_tiktok')}}" placeholder="Nhập Link.">
                                    @error('link_tiktok')
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="link_ytb" class="form-control" value="{{old('link_facebook')}}" placeholder="Nhập Link.">
                                    @error('link_facebook')
